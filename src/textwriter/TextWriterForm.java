...
public class TextWriterForm extends javax.swing.JFrame {
  ...
  public String filePath = "src/textwriter/savedText.txt";
  public ArrayList<String> words = new ArrayList();
  public FileLoader loader = new FileLoader(filePath);
  public FileSaver saver = new FileSaver(words, filePath);
  ...
  public void onInit(){
      ...
      words = fileHandler.load(filePath);
      for (String w : words) {
          allText.append(String.format(w+"%n"));
      }
  }
  ...
  private void addLine() {
    ...
    //saver.start();
    fileHandler.save(lines, filePath);
    txtNewLine.setText("");
  }
